export default {
  ...
  circuits: [
    ...
    },
    {
      ...
      repeatCount: 2,
      exercises: [
        { name: "Single Leg Calf Raise, Left", repCount: "8-10" },
        { name: "Single Leg Calf Raise, Right", repCount: "8-10" },
    ...
    },
    {
      ...
      repeatCount: 2,
      exercises: [
        { name: "Single Leg Glute Bridge, Left", repCount: "8-10" },
        { name: "Single Leg Glute Bridge, Right", repCount: "8-10" },
